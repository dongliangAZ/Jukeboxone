...
public class GUI extends JFrame{
	...
	private void setmodels() {
		...
		StudentList.addStudent("1", new Student("Chris","1"));
		StudentList.addStudent("22", new Student("Devon","22"));
		StudentList.addStudent("333", new Student("River","333"));
		StudentList.addStudent("4444", new Student("Ryan","4444"));
		//
	}
